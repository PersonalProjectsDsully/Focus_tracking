"""Focus monitoring agent implementation."""
...
from .config import (CHROME_PROFILE_PATTERN, DISTRACTION_EXES,
                     DISTRACTION_TITLE_KEYWORDS, EDGE_PROFILE_PATTERN,
                     FIREFOX_PROFILE_PATTERN, FOCUS_LOG, MEETING_EXES,
                     MEETING_TITLE_KEYWORDS, OCR_APPS, PRODUCTIVE_EXES,
                     SCRIPT_DIR)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(FOCUS_LOG, encoding="utf-8"),
